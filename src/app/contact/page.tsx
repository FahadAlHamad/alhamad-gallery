      ...
      <div className="max-w-2xl mx-auto px-6 md:px-10">
        ...
        <FadeInSection>
          <div className="mb-14">
            ...
            <h1 className="font-heading font-light text-[2.8rem] md:text-5xl leading-none mb-6">
              Enquire
            </h1>
            <p className="font-body font-light text-[0.93rem] text-secondary leading-[1.85]">
